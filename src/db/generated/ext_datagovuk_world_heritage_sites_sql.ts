...
export const getExtDatagovukWorldHeritageSitesQuery = `-- name: GetExtDatagovukWorldHeritageSites :many
SELECT
...
export interface GetExtDatagovukWorldHeritageSitesRow {
    uuid: string;
    name: string;
    reference: string;
    entryDate: Date;
...
export async function getExtDatagovukWorldHeritageSites(client: Client): Promise<GetExtDatagovukWorldHeritageSitesRow[]> {
    const result = await client.query({
        text: getExtDatagovukWorldHeritageSitesQuery,
        values: [],
        rowMode: "array"
    });
...
export const getExtDatagovukWorldHeritageSiteQuery = `-- name: GetExtDatagovukWorldHeritageSite :one
SELECT
    uuid, name, reference, entry_date, start_date, end_date, entity, notes, documentation_url, geometry, geometry_3857, geometry_27700, first_imported_at, last_imported_at
FROM
    public.ext_datagovuk_world_heritage_sites
...
export interface GetExtDatagovukWorldHeritageSiteArgs {
    uuid: string;
}

export interface GetExtDatagovukWorldHeritageSiteRow {
    uuid: string;
    name: string;
    reference: string;
    entryDate: Date;
...
export async function getExtDatagovukWorldHeritageSite(client: Client, args: GetExtDatagovukWorldHeritageSiteArgs): Promise<GetExtDatagovukWorldHeritageSiteRow | null> {
    const result = await client.query({
        text: getExtDatagovukWorldHeritageSiteQuery,
        values: [args.uuid],
        rowMode: "array"
    });
...
export const getExtDatagovukWorldHeritageSiteThatIntersectsGeometryQuery = `-- name: GetExtDatagovukWorldHeritageSiteThatIntersectsGeometry :one
SELECT
    uuid, name, reference, entry_date, start_date, end_date, entity, notes, documentation_url, geometry, geometry_3857, geometry_27700, first_imported_at, last_imported_at
FROM
    public.ext_datagovuk_world_heritage_sites
...
export interface GetExtDatagovukWorldHeritageSiteThatIntersectsGeometryArgs {
    geometry: string;
}

export interface GetExtDatagovukWorldHeritageSiteThatIntersectsGeometryRow {
    uuid: string;
    name: string;
    reference: string;
    entryDate: Date;
...
export async function getExtDatagovukWorldHeritageSiteThatIntersectsGeometry(client: Client, args: GetExtDatagovukWorldHeritageSiteThatIntersectsGeometryArgs): Promise<GetExtDatagovukWorldHeritageSiteThatIntersectsGeometryRow | null> {
    const result = await client.query({
        text: getExtDatagovukWorldHeritageSiteThatIntersectsGeometryQuery,
...
export const getExtDatagovukWorldHeritageSiteIntersectingGeometryQuery = `-- name: GetExtDatagovukWorldHeritageSiteIntersectingGeometry :many
SELECT
    uuid, name, reference, entry_date, start_date, end_date, entity, notes, documentation_url, geometry, geometry_3857, geometry_27700, first_imported_at, last_imported_at
FROM
    public.ext_datagovuk_world_heritage_sites
...
export interface GetExtDatagovukWorldHeritageSiteIntersectingGeometryArgs {
    geometry: string;
}

export interface GetExtDatagovukWorldHeritageSiteIntersectingGeometryRow {
    uuid: string;
    name: string;
    reference: string;
    entryDate: Date;
...
export async function getExtDatagovukWorldHeritageSiteIntersectingGeometry(client: Client, args: GetExtDatagovukWorldHeritageSiteIntersectingGeometryArgs): Promise<GetExtDatagovukWorldHeritageSiteIntersectingGeometryRow[]> {
    const result = await client.query({
        text: getExtDatagovukWorldHeritageSiteIntersectingGeometryQuery,
        values: [args.geometry],
        rowMode: "array"
    });
    return result.rows.map(row => {
