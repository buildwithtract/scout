-- name: UpsertExtUkpnHighVoltageOverheadLine :one
INSERT INTO
...
-- name: GetLatestImportForExtUkpnHighVoltageOverheadLines :one
SELECT
    MAX(last_imported_at)
FROM
    public.ext_ukpn_high_voltage_overhead_lines;

-- name: DeleteAllExtUkpnHighVoltageOverheadLines :exec
