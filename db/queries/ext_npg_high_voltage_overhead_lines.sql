-- name: UpsertExtNpgHighVoltageOverheadLine :one
INSERT INTO
...
-- name: GetLatestImportForExtNpgHighVoltageOverheadLines :one
SELECT
    MAX(last_imported_at)
FROM
    public.ext_npg_high_voltage_overhead_lines;

-- name: DeleteAllExtNpgHighVoltageOverheadLines :exec
