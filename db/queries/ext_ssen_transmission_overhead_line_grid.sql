-- name: GetLatestImportForExtSsenTransmissionOverheadLineGrid :one
SELECT
    MAX(last_imported_at)
FROM
    public.ext_ssen_transmission_overhead_line_grid;

-- name: UpsertExtSsenTransmissionOverheadLineGrid :one
INSERT INTO
    public.ext_ssen_transmission_overhead_line_grid (
        voltage,
        situation,
...
-- name: DeleteAllExtSsenTransmissionOverheadLineGrid :exec
